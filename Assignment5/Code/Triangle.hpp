                          ...
                          const Vector3f& dir, float& tnear, float& u, float& v)
{
    ...
    auto l1=-(v0-v1),l2=-(v0-v2);
    auto s=orig-v0;
    auto s1=crossProduct(dir,l2);
    auto s2=crossProduct(s,l1);
    tnear=dotProduct(l2,s2)/dotProduct(l1,s1);
    u=dotProduct(s,s1)/dotProduct(l1,s1);
    v=dotProduct(dir,s2)/dotProduct(l1,s1);
